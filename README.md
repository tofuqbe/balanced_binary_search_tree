This project involves creating a Balanced Binary Search Tree or BST for short. These data structures allow for fast operations involving lookup, insertion and deletion of data items.
